...
<body>
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <?php 
            ...
            $sql2 = "SELECT * from users where user_id in(SELECT user_id  from   reviews);";
            $result2 = mysqli_query($conn, $sql2);
            $sql3 = "SELECT p1.product_id, p1.name, count(r1.review_id) as counts, avg(r1.rating) as ratin_avg from products p1 join reviews r1 on p1.product_id = r1.product_id group by  p1.product_id, p1.name order by ratin_avg desc;";
